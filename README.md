...
(*現在、音声ファイルをspotifyなどでpodcastとして配信する工程のみ自動化できず、手動です。)<br>
...
**成果物**<br>https://podcasters.spotify.com/pod/show/shisowakame/episodes/TikTok--e2kftg6
<br><br>英語の文章も日本語で要約してくれます。<br>
